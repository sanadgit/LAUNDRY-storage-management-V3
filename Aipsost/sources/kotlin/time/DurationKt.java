...
public final class DurationKt {
    ...
    private static final long m1569timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1480timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1568timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1479timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1442constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1442constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1442constructorimpl((normalValue << 1) + ((long) unitDiscriminator));
    }
