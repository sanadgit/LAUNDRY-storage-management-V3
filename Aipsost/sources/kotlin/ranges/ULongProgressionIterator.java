...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    private ULongProgressionIterator(long first, long last, long step) {
        ...
        this.hasNext = z;
        this.step = ULong.m291constructorimpl(step);
        this.next = this.hasNext ? first : last;
    }

    @Override // java.util.Iterator
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m285boximpl(m1352nextsVKNKU());
    }
    ...
    public long m1352nextsVKNKU() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = ULong.m291constructorimpl(this.next + this.step);
        }
        return value;
    }
}
