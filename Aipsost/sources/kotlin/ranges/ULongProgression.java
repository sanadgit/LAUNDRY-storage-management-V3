...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1325getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM291constructorimpl = ((int) ULong.m291constructorimpl(j ^ ULong.m291constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM291constructorimpl2 = (iM291constructorimpl + ((int) ULong.m291constructorimpl(j2 ^ ULong.m291constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM291constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sbAppend = sb.append((Object) ULong.m337toStringimpl(this.first)).append("..").append((Object) ULong.m337toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            sbAppend = sb.append((Object) ULong.m337toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m337toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1351fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
