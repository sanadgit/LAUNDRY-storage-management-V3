...
final class ModuleNameRetriever {
    ...
    private final Cache buildCache(BaseContinuationImpl continuation) {
        try {
            ...
            Method nameMethod = continuation.getClass().getClassLoader().loadClass("java.lang.module.ModuleDescriptor").getDeclaredMethod(AppMeasurementSdk.ConditionalUserProperty.NAME, new Class[0]);
