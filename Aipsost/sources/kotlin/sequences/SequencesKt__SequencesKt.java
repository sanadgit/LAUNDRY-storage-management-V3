...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00471<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C00471(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C00471> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00471 c00471 = new C00471(this.$this_ifEmpty, this.$defaultValue, continuation);
            c00471.L$0 = obj;
            return c00471;
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00471(sequence, defaultValue, null));
    }
    ...
    static final class C00481<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00481(Sequence<? extends T> sequence, Random random, Continuation<? super C00481> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00481 c00481 = new C00481(this.$this_shuffled, this.$random, continuation);
            c00481.L$0 = obj;
            return c00481;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00481 = this;
                    sequenceScope = (SequenceScope) c00481.L$0;
                    mutableList = SequencesKt.toMutableList(c00481.$this_shuffled);
                    break;
                case 1:
                    c00481 = this;
                    mutableList = (List) c00481.L$1;
                    SequenceScope sequenceScope2 = (SequenceScope) c00481.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00481.$random.nextInt(mutableList.size());
                ...
                c00481.L$0 = sequenceScope;
                c00481.L$1 = mutableList;
                c00481.label = 1;
                if (sequenceScope.yield(objRemoveLast, c00481) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C00481(sequence, random, null));
    }
    ...
    static final class C00431<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00431(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C00431> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00431 c00431 = new C00431(this.$source, this.$transform, this.$iterator, continuation);
            c00431.L$0 = obj;
            return c00431;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00431 = this;
                    sequenceScope = (SequenceScope) c00431.L$0;
                    i = 0;
                    it = c00431.$source.iterator();
                    break;
                case 1:
                    c00431 = this;
                    i = c00431.I$0;
                    it = (Iterator) c00431.L$1;
                    sequenceScope = (SequenceScope) c00431.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c00431.$transform;
                int i2 = i + 1;
                if (i < 0) {
                ...
                c00431.I$0 = i2;
                c00431.label = 1;
                if (sequenceScope.yieldAll(c00431.$iterator.invoke((C) objInvoke), c00431) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C00431(source, transform, iterator, null));
    }
