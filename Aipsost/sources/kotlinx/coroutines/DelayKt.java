    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo1670scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m1606delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1607toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1607toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        if (Duration.m1441compareToLRDsOJo($this$toDelayMillis_u2dLRDsOJo, Duration.INSTANCE.m1545getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1460getInWholeMillisecondsimpl($this$toDelayMillis_u2dLRDsOJo), 1L);
        }
        return 0L;
    }
}
