...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM117constructorimpl = Result.m117constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM117constructorimpl = Result.m117constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m123isFailureimpl(objM117constructorimpl) ? null : objM117constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1646installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1646installSignalHandler$lambda1(Signal it) {
