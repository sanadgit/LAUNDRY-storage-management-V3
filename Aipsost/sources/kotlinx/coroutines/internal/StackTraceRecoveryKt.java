...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM117constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM117constructorimpl = Result.m117constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM117constructorimpl = Result.m117constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m120exceptionOrNullimpl(objM117constructorimpl) == null) {
            obj2 = objM117constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM117constructorimpl2 = Result.m117constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM117constructorimpl2 = Result.m117constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m120exceptionOrNullimpl(objM117constructorimpl2) == null) {
            obj = objM117constructorimpl2;
        }
