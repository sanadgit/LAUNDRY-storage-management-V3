...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM117constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM117constructorimpl = Result.m117constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM117constructorimpl = Result.m117constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m123isFailureimpl(objM117constructorimpl)) {
                objM117constructorimpl = null;
            }
            return (E) objM117constructorimpl;
        }
            ...
            case 0:
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        it.initCause(e);
                        objM117constructorimpl = Result.m117constructorimpl(it);
                        if (Result.m123isFailureimpl(objM117constructorimpl)) {
                            objM117constructorimpl = null;
                        }
                        return (Throwable) objM117constructorimpl;
                    }
                };
            case 1:
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        objM117constructorimpl = Result.m117constructorimpl((Throwable) objNewInstance);
                        if (Result.m123isFailureimpl(objM117constructorimpl)) {
                            objM117constructorimpl = null;
                        }
                        return (Throwable) objM117constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM117constructorimpl = Result.m117constructorimpl(function12.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM117constructorimpl = Result.m117constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM117constructorimpl = Result.m117constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM117constructorimpl = Result.m117constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m123isFailureimpl(objM117constructorimpl)) {
            objM117constructorimpl = numValueOf;
        }
        return ((Number) objM117constructorimpl).intValue();
    }
