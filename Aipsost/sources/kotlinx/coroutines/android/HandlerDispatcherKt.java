...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM117constructorimpl = Result.m117constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM117constructorimpl = Result.m117constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m123isFailureimpl(objM117constructorimpl) ? null : objM117constructorimpl);
    }
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1620postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }
    ...
    public static final void m1620postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
