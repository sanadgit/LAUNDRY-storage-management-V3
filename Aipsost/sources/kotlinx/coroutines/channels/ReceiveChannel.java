...
public interface ReceiveChannel<E> {
    ...
    Object mo1622receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1623tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1623tryReceivePtdJZtk = receiveChannel.mo1623tryReceivePtdJZtk();
            if (ChannelResult.m1639isSuccessimpl(objMo1623tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1635getOrThrowimpl(objMo1623tryReceivePtdJZtk);
            }
            Throwable thM1633exceptionOrNullimpl = ChannelResult.m1633exceptionOrNullimpl(objMo1623tryReceivePtdJZtk);
            if (thM1633exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1633exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) throws java.lang.Throwable {
            ...
            L38:
                ...
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1634getOrNullimpl(r3)
                return r3
            */
