...
public interface SendChannel<E> {
    ...
    Object mo1624trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1624trySendJP2dKIU(e);
            if (ChannelResult.m1639isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1633exceptionOrNullimpl = ChannelResult.m1633exceptionOrNullimpl(result);
