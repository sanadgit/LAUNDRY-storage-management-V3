...
public final class SavedStateViewModelFactory extends ViewModelProvider.OnRequeryFactory implements ViewModelProvider.Factory {
    ...
    public final <T extends ViewModel> T create(String key, Class<T> modelClass) {
        ...
        if (!zIsAssignableFrom || (application = this.application) == null) {
            ...
            t = (T) SavedStateViewModelFactoryKt.newInstance(modelClass, constructorFindMatchingConstructor, handle);
        } else {
            ...
            t = (T) SavedStateViewModelFactoryKt.newInstance(modelClass, constructorFindMatchingConstructor, application, handle2);
        }
