...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public SlidingPaneLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        viewDragHelperCreate.setMinVelocity(400.0f * density);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:38:0x00bd A[PHI: r9
  0x00bd: PHI (r9v2 'weightSum' float) = (r9v1 'weightSum' float), (r9v9 'weightSum' float) binds: [B:34:0x00b0, B:36:0x00b7] A[DONT_GENERATE, DONT_INLINE]] */
