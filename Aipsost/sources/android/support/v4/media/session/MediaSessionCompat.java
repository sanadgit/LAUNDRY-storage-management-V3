...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        MediaSessionImplApi21(Context context, String tag, Bundle token2Bundle) {
            Object objCreateSession = MediaSessionCompatApi21.createSession(context, tag);
            this.mSessionObj = objCreateSession;
            this.mToken = new Token(MediaSessionCompatApi21.getSessionToken(objCreateSession), new ExtraSession(), token2Bundle);
        }

        MediaSessionImplApi21(Object mediaSession) {
            Object objVerifySession = MediaSessionCompatApi21.verifySession(mediaSession);
