...
public class JobInfoScheduler implements WorkScheduler {
    ...
    int getJobId(TransportContext transportContext) {
        ...
        checksum.update(this.context.getPackageName().getBytes(Charset.forName(Key.STRING_CHARSET_NAME)));
        checksum.update(transportContext.getBackendName().getBytes(Charset.forName(Key.STRING_CHARSET_NAME)));
