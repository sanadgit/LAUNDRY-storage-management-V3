    ...
    public ResultPoint[] detect() throws NotFoundException {
        ...
        while (true) {
            ...
            while (true) {
                ...
                boolean zContainsBlackPoint = containsBlackPoint(up, down2, right, false);
            ...
            while (true) {
                ...
                boolean zContainsBlackPoint2 = containsBlackPoint(left, right, down2, true);
            ...
            while (true) {
                ...
                boolean zContainsBlackPoint3 = containsBlackPoint(up, down2, left, false);
            ...
            while (true) {
                ...
                int down3 = down2;
                boolean zContainsBlackPoint4 = containsBlackPoint(left, right, up, true);
