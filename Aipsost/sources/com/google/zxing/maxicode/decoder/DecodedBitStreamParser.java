...
final class DecodedBitStreamParser {
    ...
    private static int getPostCode2Length(byte[] bytes) {
        return getInt(bytes, new byte[]{39, 40, 41, 42, PrinterCommands.US, 32});
    }

    private static int getPostCode2(byte[] bytes) {
        return getInt(bytes, new byte[]{33, 34, 35, 36, 25, 26, PrinterCommands.ESC, PrinterCommands.FS, PrinterCommands.GS, 30, 19, 20, 21, 22, 23, PrinterCommands.CAN, PrinterCommands.CR, 14, 15, PrinterCommands.DLE, 17, 18, 7, 8, 9, 10, 11, PrinterCommands.CLR, 1, 2});
    }

    private static String getPostCode3(byte[] bytes) {
        String[] strArr = SETS;
        return String.valueOf(new char[]{strArr[0].charAt(getInt(bytes, new byte[]{39, 40, 41, 42, PrinterCommands.US, 32})), strArr[0].charAt(getInt(bytes, new byte[]{33, 34, 35, 36, 25, 26})), strArr[0].charAt(getInt(bytes, new byte[]{PrinterCommands.ESC, PrinterCommands.FS, PrinterCommands.GS, 30, 19, 20})), strArr[0].charAt(getInt(bytes, new byte[]{21, 22, 23, PrinterCommands.CAN, PrinterCommands.CR, 14})), strArr[0].charAt(getInt(bytes, new byte[]{15, PrinterCommands.DLE, 17, 18, 7, 8})), strArr[0].charAt(getInt(bytes, new byte[]{9, 10, 11, PrinterCommands.CLR, 1, 2}))});
    }
