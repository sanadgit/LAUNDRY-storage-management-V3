...
public final class CameraConfigurationUtils {
    ...
    public static void setTorch(Camera.Parameters parameters, boolean on) {
        ...
        String flashMode = on ? findSettableValue("flash mode", supportedFlashModes, "torch", DebugKt.DEBUG_PROPERTY_VALUE_ON) : findSettableValue("flash mode", supportedFlashModes, DebugKt.DEBUG_PROPERTY_VALUE_OFF);
        if (flashMode != null) {
