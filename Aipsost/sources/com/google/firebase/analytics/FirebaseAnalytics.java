...
public final class FirebaseAnalytics {
    ...
    public static zzhx getScionFrontendApiImplementation(Context context, Bundle extraParams) {
        zzee zzeeVarZza = zzee.zza(context, null, null, null, extraParams);
        if (zzeeVarZza == null) {
            return null;
        }
        return new zzc(zzeeVarZza);
    }
    ...
    public void setAnalyticsCollectionEnabled(boolean enabled) {
        this.zzb.zzp(Boolean.valueOf(enabled));
    }
    ...
    public void setCurrentScreen(Activity activity, String screenName, String screenClassOverride) {
        this.zzb.zzo(activity, screenName, screenClassOverride);
    }
    ...
    public void setUserProperty(String name, String value) {
        this.zzb.zzj(null, name, value, false);
    }
}
