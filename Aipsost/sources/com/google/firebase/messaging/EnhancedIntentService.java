...
public abstract class EnhancedIntentService extends Service {
    ...
    @Override // android.app.Service
    public final int onStartCommand(final Intent originalIntent, int i, int startId) {
        synchronized (this.lock) {
        ...
        taskProcessIntent.addOnCompleteListener(EnhancedIntentService$$Lambda$1.$instance, new OnCompleteListener(this, originalIntent) { // from class: com.google.firebase.messaging.EnhancedIntentService$$Lambda$2
            private final EnhancedIntentService arg$1;
            private final Intent arg$2;
