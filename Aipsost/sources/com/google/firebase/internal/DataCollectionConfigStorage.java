...
public class DataCollectionConfigStorage {
    ...
    public DataCollectionConfigStorage(Context applicationContext, String persistenceKey, Publisher publisher) {
        Context contextDirectBootSafe = directBootSafe(applicationContext);
        this.deviceProtectedContext = contextDirectBootSafe;
        this.sharedPreferences = contextDirectBootSafe.getSharedPreferences(FIREBASE_APP_PREFS + persistenceKey, 0);
