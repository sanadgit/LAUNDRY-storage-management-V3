...
public class ActivityComponentManager implements GeneratedComponentManager<Object> {
    ...
    protected Object createComponent() {
        ...
        if (!(this.activity.getApplication() instanceof GeneratedComponentManager)) {
            StringBuilder sbAppend = new StringBuilder().append("Hilt Activity must be attached to an @HiltAndroidApp Application. ");
            ...
            throw new IllegalStateException(sbAppend.append(str).toString());
        }
