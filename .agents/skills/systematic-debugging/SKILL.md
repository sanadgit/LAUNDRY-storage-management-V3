...
1. **Create Failing Test Case**
   ...
   - Use the project's automated-testing guidance for writing proper failing tests
...
These techniques are part of systematic debugging and available in this skill:
...
**Related skills:**
- **automated-testing** - For creating failing test cases and regression coverage
