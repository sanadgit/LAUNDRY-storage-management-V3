...
Hosted Firecrawl CLI or API workflows require `FIRECRAWL_API_KEY`.
Read it from the environment or approved secret storage only.
Do not place the key in generated artifacts, logs, or `DESIGN.md`.
