...
export default function Grid2DNew({
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ? 'warehouse-grid-cell--selected ring-2'
                        : cell.isTarget
                        ? 'warehouse-grid-cell--target scale-110 z-10 ring-4 ring-emerald-400/50'
                        : cell.count > 0
                        ? isFull
                          ? 'warehouse-grid-cell--occupied'
                          : 'warehouse-grid-cell--busy'
                        : 'warehouse-grid-cell--empty'
                    )}
                  ...
                  >
                    {isDraftTarget ? (
                      ...
                      <span className="opacity-40 text-slate-500 font-mono text-xs">
                        {cell.r}:{cell.c}
                      </span>
                    )}
